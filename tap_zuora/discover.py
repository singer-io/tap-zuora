...
UNSUPPORTED_FIELDS_FOR_REST = {
    "Account": ["PaymentMethodPriorityId"],
    "BillingRun": ["IncludeOrderLineItems", "IncludeSubscriptions"],
    "Contact": ["AsBillTo", "AsShipTo", "AsSoldTo"],
    "Invoice": ["CommunicationProfileId"],
    "CreditMemo": ["CommunicationProfileId"],
    "CreditMemoItem":["ExchangeRateDate"],
    "DebitMemo": ["CommunicationProfileId"],
    "InvoiceItem": ["Balance",
