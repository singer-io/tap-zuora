...
class Aqua:
    ...
    def get_payload(state: Dict, stream: Dict, partner_id: str) -> Dict:
        ...
        payload = Aqua.make_payload(project, query, partner_id, deleted)
    ...
    @staticmethod
    def create_job(client, state: Dict, stream: Dict) -> str:
    ...
    @staticmethod
    def stream_status(client, stream_name: str) -> str:
        """
        ...
        payload = Aqua.make_payload("discover", query, client.partner_id)
        resp = client.aqua_request("POST", endpoint, json=payload).json()
    ...
    @staticmethod
    def job_ready(client, job_id: str) -> bool:
    ...
    # Must match call signature of other APIs
    @staticmethod
    def get_file_ids(client, job_id: str) -> List:
        endpoint = f"v1/batch-query/jobs/{job_id}"
        data = client.aqua_request("GET", endpoint).json()
    ...
    # Must match call signature of other APIs
    @staticmethod
    def stream_file(client, file_id: str):
...
class Rest:
    ...
    @staticmethod
    def create_job(client, stream: Dict, start_date: Union[str, None] = None, end_date: Union[str, None] = None) -> str:
