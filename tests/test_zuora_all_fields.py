...
DOES_NOT_SUPPORT_DELETED = ['AccountingPeriod', 'ContactSnapshot', 'DiscountAppliedMetrics', 'UpdaterDetail',
'PaymentGatewayReconciliationEventLog', 'PaymentTransactionLog', 'PaymentMethodTransactionLog', 'UpdaterBatch', 
'PaymentReconciliationJob', 'PaymentReconciliationLog', 'ProcessedUsage', 'RefundTransactionLog', 
'BookingTransaction', 'CalloutHistory', 'SmartPreventionAudit', 'HpmCaptchaValidationResult','EmailHistory']
    ...
    def run_test(self, api_type):
        ...
        for stream in expected_streams:
            with self.subTest(stream=stream):
                ...
                actual_all_keys = set()
                expected_all_keys = expected_all_keys - {'Deleted'}  \
                if stream in DOES_NOT_SUPPORT_DELETED else expected_all_keys
